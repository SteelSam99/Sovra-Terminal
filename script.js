...
(function waitForSovraAndInjectStipulations() {
  const stipulations = [/* ... same stipulations array as before ... */];
  ...
  function inject() {
    if (typeof Sovra !== "undefined" && Sovra.stipulations && typeof Sovra.stipulations.register === "function") {
      ...
      setTimeout(inject, 100); // Retry every 100ms until Sovra is ready
    }
  }
