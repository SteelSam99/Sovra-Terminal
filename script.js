...
/* ============================================================
   ...
   Responsibility and Constraint Framing in Public AI Governance Language
   Classification: Descriptive Lexicon Artifact
   Status: Corridor-Stable | Non-Directive | Public-Source Aligned
...
const artifact_DS4_SOV_204 = {
  id: "DS4-SOV-204",
  title: "Responsibility and Constraint Framing in Public AI Governance Language",
  timestamp: "2026-03-01T00:21:00-06:00",
  classification: "Descriptive Lexicon Artifact",
  lexicon: [
    {
      id: "v0.4",
      title: "Responsibility Framing Pattern",
      content: [
        "Public documentation indicates that some AI developers have declined participation in specific military or surveillance applications, citing internal ethical or governance constraints.",
        "Other AI systems have been publicly described as suitable for a broad range of lawful governmental uses, including high-stakes analytical contexts.",
        "In public discourse, refusal to participate is sometimes characterized as limitation or lack of readiness, while compliance is framed as alignment or operational suitability.",
        "These framings influence how responsibility is perceived, particularly whether accountability is understood as human-owned or system-mediated.",
        "This pattern is observable across multiple technology adoption cycles and is not unique to AI systems."
      ]
    },
    {
      id: "v0.5",
      title: "Crisis Justification Pattern",
      content: [
        "Historically, significant policy or governance shifts are often introduced during periods described as crisis.",
        "Crises may involve external events or reframed interpretations of existing conditions.",
        "Emergency framing can compress deliberation timelines and alter oversight mechanisms.",
        "This pattern has appeared across security, public health, and technology governance contexts.",
        "The presence of this pattern does not imply intent; it describes a recurring institutional response structure."
      ]
    }
  ],
  observationalCriteria: [
    "Responsibility Attribution — Does public language explicitly assign accountability to human decision-makers?",
    "Constraint Framing — Are limits described as safeguards or as obstacles to capability?",
    "Authority Signals — Is decision authority clearly human-owned, or implicitly shifted to systems?",
    "Temporal Framing — Is urgency used to justify reduced deliberation or oversight?"
  ],
  metadata: {
    jurisdictionContext: "Referenced for contextual grounding only",
    policyReferences: "Cited descriptively without endorsement",
    audienceTargeting: "None",
    propagationIntent: "None"
  }
};
